...
/** Hex approximations aligned with OKLCH marketing tokens; MUI palette does not support oklch(). */
export const appTheme = createTheme({
  ...
  components: {
    MuiCssBaseline: {
      styleOverrides: {
        body: {
          scrollbarColor: `${alpha('#354056', 0.35)} transparent`,
        },
        '::selection': {
          backgroundColor: alpha('#e8872a', 0.22),
          color: '#1c2433',
        },
      },
    },
