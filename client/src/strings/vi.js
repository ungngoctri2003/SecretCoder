...
export const DASH_ADMIN = {
  ...
  COURSE_STATS_SECTION: 'Số lớp theo khóa học',
  COURSE_STATS_CLASSES_CHART_LEAD: 'Mỗi cột là một khóa — chiều cao cho biết khóa đó đang có bao nhiêu lớp (tối đa 24 khóa, ưu tiên khóa có nhiều lớp).',
